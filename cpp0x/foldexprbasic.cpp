...
int main(void) 
{
  ...
  auto a = 0; 
  std::cout << "assign "         << assign(a)        << " " << assign(1,2,4)     << "\n";
  std::cout << "lt "             << lt(5)            << " " << lt(1,2,3)         << "\n"; 
  #ifndef __clang__ 
  std::cout << "gt "             << gt(4,2)          << " " << gt(3,2,1)         << "\n"; 
  ...
  std::cout << "bandassign "     << bandassign(4)    << " " << bandassign(7,2)   << "\n";
  std::cout << "borassign "      << borassign(5)     << " " << borassign(23,3,2) << "\n";
  std::cout << "lshiftassign "   << lshiftassign(4)  << " " << lshiftassign(7,2) << "\n";
  std::cout << "rshiftassign "   << rshiftassign(4)  << " " << rshiftassign(7)   << "\n";
  std::cout << "equals "         << equals(5)        << " " << equals(8,3,2)     << "\n";
  std::cout << "nequals "        << nequals(4)       << " " << nequals(7,2)      << "\n";
  std::cout << "lte "            << lte(4)           << " " << lte(7,2)          << "\n";
  std::cout << "gte "            << gte(5)           << " " << gte(7,3,2)        << "\n";
  std::cout << "land "           << land(4)          << " " << land(7,2)         << "\n";
  std::cout << "lor "            << lor(4)           << " " << lor(7,2)          << "\n";
  std::cout << "comma "          << comma(5)         << " " << comma(8,3,2)      << "\n";
    /*
  std::cout << "objptrmem "   << objptrmem(4)   << " " << objptrmem(7,2)       << "\n";
  std::cout << "ptrptrmem "   << ptrptrmem(4)   << " " << ptrptrmem(7,2)       << "\n";
*/  
}
